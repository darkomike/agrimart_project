...
import 'package:block_agri_mart/domain/home/components/sell_all_recommends.dart';
              ...
              child: TextButton(
                  onPressed: () {
                    AppUtils.navigatePush(
                        context: context,
                        destination: SeeAllRecommendsScreen());
                  },
                  child: CustomShaderMask(
                    blendMode: BlendMode.srcIn,
